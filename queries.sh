...
echo  "$($PSQL "SELECT winner, opponent FROM games WHERE year = 2014 AND round = 'Eighth-Final'")"
...
echo  "$($PSQL "SELECT winner, opponent FROM games WHERE winner LIKE 'Co%' OR opponent LIKE 'Co%'")"
